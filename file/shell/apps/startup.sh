...
sleep 3s
nohup java -jar -Xmx128m -XX:MaxMetaspaceSize=128m -XX:CompressedClassSpaceSize=24m ./app-service-user/TestUser-1.0.jar &

sleep 3s
nohup java -jar -Xmx128m -XX:MaxMetaspaceSize=128m -XX:CompressedClassSpaceSize=24m ./app-web/TestWeb-1.0.jar &
